...
Vous pouvez visiter le site en cliquant <a href="https://github-ui-clone-with-dark-mode.netlify.app/" target="_blank"><strong>ici</strong></a> , et tirer vous propres conclusions en alternant entre le mode Dark et Light à l'aide du bouton Switch trouvé dans l'en-tête de la page.
